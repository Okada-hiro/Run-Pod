...
FT_MODEL_FILE = "Ref_voice_e56_s500.safetensors"
...
if __name__ == "__main__":
    ...
    if GLOBAL_TTS_MODEL is None:
        ...
        TEST_TEXT = "こんにちは。今日は、午後から雨が降る予報です。傘は持って行ったほうが安心ですよ。せっかくならカフェに行きましょう。どういたしまして。どこのカフェに行きますか？例えば、はい、駅前のカフェは通常通り営業していますよ。いいですね。昼になると、混みはじめるかもしれないので、少し早めに行くと落ち着けますよ。"
